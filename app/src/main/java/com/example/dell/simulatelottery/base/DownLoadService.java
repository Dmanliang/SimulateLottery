...
public class DownLoadService extends Service {
    ...
    private String url;
    private String DOWNLOADPATH = "/模拟彩票/apk/";
    ...
    private void initDownManager() {
        ...
        down.setDestinationInExternalPublicDir(DOWNLOADPATH,"模拟彩票.apk");
        down.setTitle("模拟彩票");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        String path = Environment.getExternalStorageDirectory().getAbsolutePath()+ DOWNLOADPATH + "模拟彩票.apk";
